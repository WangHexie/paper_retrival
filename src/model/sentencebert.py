import json
from typing import Optional, Iterable, Tuple, Type, Dict, Callable
...
class EnhancedSentenceTransformer(SentenceTransformer):
                ...
                for train_idx in range(num_train_objectives):
                    ...
                    if use_amp:
                        ...
                        if log_writer is not None:
                            log_writer.add_scalar('Loss/train', loss_value, epoch*steps_per_epoch+step)
                        loss_value.backward()
                        torch.nn.utils.clip_grad_norm_(loss_model.parameters(), max_grad_norm)
                        optimizer.step()
